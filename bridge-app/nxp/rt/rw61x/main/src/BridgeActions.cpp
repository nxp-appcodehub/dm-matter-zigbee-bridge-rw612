...
int BridgeActions::handle(uint16_t actionID, EndpointId endpointID, uint32_t invokeID, bool hasInvokeID, BridgeDevMgr* gDevMgr)
{
    ...
    {
		ChipLogError(DeviceLayer, "\n ### Before StartNetwork =%d,%d,%ld,%d ### ",actionID,endpointID,invokeID,hasInvokeID);
    ...
    {
		ChipLogError(DeviceLayer, "\n ### Before PermitJoinAction =%d,%d,%ld,%d ### ",actionID,endpointID,invokeID,hasInvokeID);
    ...
    {
		ChipLogError(DeviceLayer, "\n ### Before FactoryReset =%d,%d,%ld,%d ### ",actionID,endpointID,invokeID,hasInvokeID);
