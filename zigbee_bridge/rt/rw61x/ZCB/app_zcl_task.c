...
static void APP_ZCL_cbEndpointCallback(tsZCL_CallBackEvent *psEvent)
{
    ...
    switch (psEvent->eEventType)
    {
        ...
        case E_ZCL_CBET_READ_INDIVIDUAL_ATTRIBUTE_RESPONSE:
            ...
            u16SizeOfAttribute =  APP_u16GetAttributeActualSize((uint32_t)psEvent->uMessage.sIndividualAttributeResponse.eAttributeDataType, u16Elements);
            
            ZCB_HandleReadAttrResp(psEvent->pZPSevent->uEvent.sApsDataIndEvent.uSrcAddress.u16Addr,
        ...
        case E_ZCL_CBET_REPORT_INDIVIDUAL_ATTRIBUTE:
            if(psEvent->psClusterInstance != NULL)
            {
                ...
                u16SizeOfAttribute =  APP_u16GetAttributeActualSize((uint32_t)psEvent->uMessage.sIndividualAttributeResponse.eAttributeDataType, u16Elements);
                memcpy(&u64Data, psEvent->uMessage.sIndividualAttributeResponse.pvAttributeData, u16SizeOfAttribute);
                ZCB_HandleAttributeReport(psEvent->pZPSevent->uEvent.sApsDataIndEvent.uSrcAddress.u16Addr,
                                        psEvent->pZPSevent->uEvent.sApsDataIndEvent.u8SrcEndpoint,
                                        psEvent->pZPSevent->uEvent.sApsDataIndEvent.u16ClusterId,
                                        psEvent->uMessage.sIndividualAttributeResponse.u16AttributeEnum,
                                        psEvent->uMessage.sIndividualAttributeResponse.eAttributeStatus,
